<template>
  <div class="m_h65">
    <div class="m_h6">全球网络安全防御图分布情况</div>
    <div class="m_h90"  id="mid_top">
  ...
  methods: {
    earthApply () {
      ...
      let midTopOption = {
        ...
        },
        {
          ...
          data: populiton.filter(function (dataItem) {
            ...
            return [dataItem[0], dataItem[1], 200]
          })
        },
        {
          type: 'scatter3D',
      ...
      for (let i = 0; i < 200; i++) {
        ...
        midTopOption.series[1].data = midTopOption.series[1].data.concat(locate)
      }
      EC.setOption(midTopOption)
    }
  },
  mounted () {
    this.earthApply('mid_top')
  },
  created () {
  }
}
...
<style scoped>
  @import "../../../static/css/controlcabin.css";
</style>
